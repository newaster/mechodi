...
if ($_SESSION['role'] == 'user') {
    $sqlSelectSites = "select * from zone  where updated_by = '{$_SESSION['user_id']}'  group by unique_id  order by id desc ";
} else if ($_SESSION['role'] == 'admin') {
    $sqlSelectSites = "select * from zone   group by unique_id   order by id desc ";
} else if ($_SESSION['role'] == 'guest') {
    $sqlSelectSites = "select sites.*, zone.* from zone inner join sites on zone.number = sites.number where zone.unique_id in ('{$_SESSION['zone']}')  group by unique_id  order by sites.id desc ";
}
                    ...
                    <div class="body ">
                        ...
                        <select class="form-control show-tick ms select2" id="site_select" data-placeholder="Select">
                            ...
                            foreach ($arrSites as $keySites => $valSites) {
                                ?>
                                <option  value="<?php echo $valSites['unique_id']; ?>" ><?php echo $valSites['name']; ?></option>
                                        ...
                                        <table  class="table table-bordered table-striped table-hover dataTable js-exportable" data-page-length="10"  >
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th width="10%" scope="col">AVERAGE VALUE</th>
                                        ...
                                        <table  class="table table-bordered table-striped table-hover dataTable js-exportable" data-page-length="10"  >
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th width="30%" scope="col">PARAMETER</th>
                                                    <th width="10%" scope="col">TOTAL VALUE</th>
...
//        }
        ...
        $("#site_select").on("change", function () {
            ...
            $.post("ajaxCall.php", {operation: "zone-kld", id: sid}, function (data) {
                console.log(data);
        ...
        $(".duration").on("click", function () {
            ...
            var opr =  "get-trend-zone";// "get-zone-parameter-trend";
    ...
    function setAction() {
        $(".action").on("click", function () {
            ...
            var id = $("#site_select").val();
            $.post("ajaxCall.php", {operation: "get-zone-parameter-trend", param: param, duration: "DAY", id: id}, function (data) {
