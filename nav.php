...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="main.php"><img src="assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li class="active open"><a href="main.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
